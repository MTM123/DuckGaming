...
public class PlayerEventHandler implements Listener {
	...
	public void onPlayerChat(AsyncPlayerChatEvent event) {
		...
		if (!isCancelled) {
			...
			if (!muted) {
				...
				$.getLinkServer().getBungeeListener().broadcastMessage(player, msg);
			}
			for (Player onlinePlayer : Bukkit.getOnlinePlayers()) {
				if (muted) {
					int rankID = Link$.getRankId(onlinePlayer);
	...
	public void onPlayerAuthenticate(PlayerAuthenticateEvent event) {
		...
		$.getLinkServer().getBungeeListener().broadcastMessage(player, event.getJoinMessage());
	}
	...
	public void onPlayerQuit(PlayerQuitEvent event) {
		...
		$.getLinkServer().getBungeeListener().broadcastMessage(player, event.getQuitMessage());
	}
