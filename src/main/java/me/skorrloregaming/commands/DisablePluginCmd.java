...
public class DisablePluginCmd implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (!(plugin == null)) {
			Server.getPlugin().getServer().getPluginManager().disablePlugin(plugin);
			sender.sendMessage($.Legacy.tag + ChatColor.RED + "Success. " + ChatColor.GRAY + "Disabled the plugin ... " + ChatColor.RED + plugin.getName());
		} else {
