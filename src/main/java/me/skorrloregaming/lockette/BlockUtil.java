...
public class BlockUtil {
    ...
    public static final Material[] materialListDoors = {Material.OAK_DOOR, Material.IRON_DOOR, Material.OAK_FENCE_GATE, Material.ACACIA_DOOR, Material.ACACIA_FENCE_GATE, Material.BIRCH_DOOR, Material.BIRCH_FENCE_GATE, Material.DARK_OAK_DOOR, Material.DARK_OAK_FENCE_GATE, Material.JUNGLE_DOOR, Material.JUNGLE_FENCE_GATE, Material.SPRUCE_DOOR, Material.SPRUCE_FENCE_GATE, Material.LEGACY_WOODEN_DOOR};
    public static final Material[] materialListJustDoors = {Material.OAK_DOOR, Material.IRON_DOOR, Material.ACACIA_DOOR, Material.BIRCH_DOOR, Material.DARK_OAK_DOOR, Material.JUNGLE_DOOR, Material.SPRUCE_DOOR, Material.LEGACY_WOODEN_DOOR};
    public static final Material[] materialListWoodenDoors = {Material.LEGACY_TRAP_DOOR, Material.LEGACY_WOODEN_DOOR, Material.LEGACY_FENCE_GATE, Material.ACACIA_DOOR, Material.ACACIA_FENCE_GATE, Material.BIRCH_DOOR, Material.BIRCH_FENCE_GATE, Material.DARK_OAK_DOOR, Material.DARK_OAK_FENCE_GATE, Material.JUNGLE_DOOR, Material.JUNGLE_FENCE_GATE, Material.SPRUCE_DOOR, Material.SPRUCE_FENCE_GATE, Material.OAK_DOOR};
